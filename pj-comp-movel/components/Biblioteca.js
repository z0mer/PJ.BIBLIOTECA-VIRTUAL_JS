    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity
          style={[
            styles.button,
            hoveredButton === 'CadastrarLeitura' && styles.buttonHover,
          ]}
          onPress={() => navigation.navigate('CadastrarLeitura')}
          onMouseEnter={() => handleMouseEnter('CadastrarLeitura')}
        ...
        <TouchableOpacity
          style={[
            styles.button,
            hoveredButton === 'Estante' && styles.buttonHover,
          ]}
          onPress={() => navigation.navigate('Estante')}
          onMouseEnter={() => handleMouseEnter('Estante')}
          onMouseLeave={handleMouseLeave}>
